    ...
    <div class="min-h-screen">
      ...
      <main>
        ...
        <section class="bg-gray-50 py-12">
          <div class="container mx-auto px-4">
            <div class="flex items-center gap-4 mb-4">
              <NuxtLink to="/categories" class="text-blue-600 hover:underline">Categories</NuxtLink>
              <span class="text-gray-400">/</span>
              <h1 class="text-4xl font-bold">{{ categoryData.name }}</h1>
            </div>
        ...
        <section class="py-8 bg-white">
          <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold mb-6">Featured Review</h2>
            <div class="bg-gray-50 rounded-lg overflow-hidden">
              <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="aspect-video bg-gray-200"></div>
                <div class="p-8">
                  <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded mb-4 inline-block">
                    Featured
                  </span>
                  <h3 class="text-2xl font-bold mb-4">{{ categoryData.featuredReview.title }}</h3>
                  <p class="text-gray-600 mb-4">{{ categoryData.featuredReview.excerpt }}</p>
                  <div class="flex items-center gap-4">
                    <span class="text-yellow-400">★★★★☆</span>
                    <span class="text-gray-500">Posted {{ categoryData.featuredReview.date }}</span>
                  </div>
                  <NuxtLink :to="categoryData.featuredReview.link" class="text-blue-600 hover:underline mt-4 inline-block">
                    Read Full Review →
                  </NuxtLink>
                </div>
              </div>
              ...
              <div v-for="review in categoryData.reviews" :key="review.id" 
                ...
                <div class="p-6">
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <NuxtLink :to="review.link" class="text-blue-600 hover:underline">
                      Read Review →
                    </NuxtLink>
                  </div>
                </div>
          ...
          <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div class="bg-white rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-blue-600 mb-2">{{ categoryData.stats.totalReviews }}</div>
                <div class="text-gray-600">Total Reviews</div>
              </div>
              <div class="bg-white rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-blue-600 mb-2">{{ categoryData.stats.avgRating }}</div>
                <div class="text-gray-600">Average Rating</div>
              </div>
              <div class="bg-white rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-blue-600 mb-2">{{ categoryData.stats.brands }}</div>
                <div class="text-gray-600">Brands Reviewed</div>
              </div>
            </div>
          </div>
        </section>
